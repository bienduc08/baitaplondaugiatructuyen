...
public class UserDAO {
    ...
    public UserDTO getUserByUsername(String username) {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            System.err.println("[UserDAO] getUserByUsername lỗi: " + e.getMessage());
        }
        return null;
    }
    ...
    // Thêm hàm helper này vào UserDAO
    private UserDTO mapRow(ResultSet rs) throws SQLException {
        ...
        try { user.setBalance(rs.getBigDecimal("balance")); }  catch (SQLException e) { user.setBalance(BigDecimal.ZERO); }
