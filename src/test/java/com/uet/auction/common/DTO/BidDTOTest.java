...
public class BidDTOTest {
    ...
    public void testParameterizedConstructor() {
        BidDTO dto = new BidDTO(12, 345, "bob_bidder", new BigDecimal("120000.0"), "2026-06-01 21:00:00", "Hợp lệ");

        assertEquals(12, dto.getId());
        assertEquals(345, dto.getProductId());
        assertEquals("bob_bidder", dto.getBiddername());
        assertEquals(new BigDecimal("120000.0"), dto.getPrice());
    ...
    public void testSettersAndGetters() {
        ...
        dto.setPrice(new BigDecimal("150000.5"));
        ...
        assertEquals(new BigDecimal("150000.5"), dto.getPrice());
